/**
 * @file wxScopeServerApp.h
 *****************************************************************************
 * wxScopeServerApp
 *
 * Definition of a wxWidgets GUI application main program
 *
 *<hr>
 *
...
#ifndef WXSCOPESERVERAPP_H
#define WXSCOPESERVERAPP_H
...
class wxScopeServerApp : public wxApp
{
	public:
		virtual bool OnInit();
};

#endif // wxScopeServerAPP_H
